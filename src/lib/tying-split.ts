 ...
 *
 * No per-safa rate. This sits on the order list, which is open at the counter
 * with customers on the other side of it; the rate belongs in the artist's own
 * ledger, where settling up happens.
 */
